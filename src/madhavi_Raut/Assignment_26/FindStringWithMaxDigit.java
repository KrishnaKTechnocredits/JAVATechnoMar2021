package madhavi_Raut.Assignment_26;
...
public class FindStringWithMaxDigit {
	...
	public static void main(String[] args) {
		...
		System.out.println(new FindStringWithMaxDigit().getStringWithMaxDigit(new String[] {"P1u2r2va", "1K2omal", "9S4hivan4i4", "1K2r3ati", "4M4a5d5h1v1i93"} ));
	}
}
