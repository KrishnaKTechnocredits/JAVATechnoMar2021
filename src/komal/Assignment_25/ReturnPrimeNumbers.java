...
public class ReturnPrimeNumbers {
	public static void main(String[] args) {

		ReturnPrimeNumbers returnPrimeNumbers = new ReturnPrimeNumbers();
		...
		int[] primeNumArr = returnPrimeNumbers.getPrimeNumbers(startIndex, endIndex);
