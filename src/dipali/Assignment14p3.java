...
public class Assignment14p3 {
	...
	public static void main(String[] args) {
		try (Scanner scanner = new Scanner(System.in)) {
			Assignment14p3 assignment14p3=new Assignment14p3();
			int maggieCnt=scanner.nextInt();
			assignment14p3.placeOrder("Maggie", maggieCnt, true);
			int dosaCnt=scanner.nextInt();
			assignment14p3.placeOrder("Dosa", dosaCnt, true);
			int oilPouchCnt=scanner.nextInt();
			assignment14p3.placeOrder("Pouches", oilPouchCnt, true);
			int panipuriCnt=scanner.nextInt();
			assignment14p3.placeOrder("Panipuri", panipuriCnt, true);
			int masalaCnt=scanner.nextInt();
			assignment14p3.placeOrder("Masala", masalaCnt, true);
		}
	}
