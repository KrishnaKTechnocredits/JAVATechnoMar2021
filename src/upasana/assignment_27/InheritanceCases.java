...
public class InheritanceCases {
	public static void main(String[] args) {
		...
		// and it is possible as we are referring child class to parent class and at the time of compilation
		// only those methods and variables which are present in parent class are compiled but at the time of 
		//running it methods present in child class are accessed and printed and this change is seen with methods 
		//not variables.
		// NOTE: methods present in parent and child class should have same signature means with same parameters
		//and same return type and if methods are same with same parameters but different return type then it will
	...
	//	a2.m3();
		...
		//		B b3 = new A(); // CE bcz we cant assign the parent class object to child class reference type.
				...
				a4=b4; //it means A a4 = new B(); class B's object is kept in class A's reference type.
