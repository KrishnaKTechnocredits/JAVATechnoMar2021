...
public class FreqAllCharStringArray {
	...
	void calculateFrequencyAllChar(String str1, char ch) {
		...
		System.out.println("Frequency of character " + ch + " in " + str1 + " is --> " + cnt);
	}
	...
	public static void main(String[] args) {
		...
		for (int index=0; index<str.length; index++)
			new FreqAllCharStringArray().extractEachCharFromWord(str[index]);
	}
}
