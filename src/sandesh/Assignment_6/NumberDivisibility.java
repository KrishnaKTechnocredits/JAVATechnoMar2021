...
public class NumberDivisibility {
	...
	public static void main(String[] args) {
		...
		new NumberDivisibility().getEvenNumbers(startNum, endNum);
		new NumberDivisibility().getDivisibleByFiveNumbers(startNum, endNum);
		new NumberDivisibility().getDivisibleByThreeAndFiveNumbers(startNum, endNum);
		new NumberDivisibility().getDivisibleBySevenOrThirteenNumbers(startNum, endNum);
		sc1.close();
	}
}
