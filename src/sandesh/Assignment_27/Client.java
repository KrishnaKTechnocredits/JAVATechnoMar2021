package sandesh.Assignment_27;

public class Client {

	public static void main(String[] args) {
		//Case 1
		System.out.println("<------- Output of Case 1 -------> Parent p1 = new Parent();");
		...
		//Case 2
		System.out.println("<------- Output of Case 2 -------> Child c1 = new Child();");
		Child c1 = new Child();
		...
		//System.out.println(p2.z);	// [CE as z is not present in Parent and hence cannot be guaranteed]
		p2.m1();	//Parent m1
		p2.m2();	//Child m2
		//p2.m3();	//Child m3	// [CE as z is not present in Parent and hence cannot be guaranteed]
		System.out.println("-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+");
		
		//Case 4
		System.out.println("<------- Output of Case 4 -------> Child c1 = new Parent();");
		...
		//System.out.println(p3.z);	// [CE as z is not present in Parent and hence cannot be guaranteed]
		p3.m1();	//Parent m1
		p3.m2();	//Child m2
		//p3.m3();	//Child m3	// [CE as z is not present in Parent and hence cannot be guaranteed]
		System.out.println("-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+");
		...
		//System.out.println(c4.z);	// [CE as z is not present in Parent and hence cannot be guaranteed]
		c4.m1();	//Parent m1
		c4.m2();	//Child m2
		//c4.m3();	// [CE as z is not present in Parent and hence cannot be guaranteed]
		System.out.println("-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+");
