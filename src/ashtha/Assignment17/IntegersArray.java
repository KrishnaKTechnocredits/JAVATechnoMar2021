...
public class IntegersArray {
	...
	/*
	 * Method to count odd and even from given numbers Method to return a difference
	 * between sum of even number and odd numbers.
	 */
	...
	public static void main(String[] args) {
		...
		if (flag)
			System.out.println("The number " + targetNumber + " is present in the array and the frequency of number = "
					+ frequencyOfNumber);
		else
