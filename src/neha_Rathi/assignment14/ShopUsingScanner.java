...
public class ShopUsingScanner {
	...
	public static void main(String[] args) {
		...
		System.out.println("enter initail quantity: ");
		shop.intialQ(sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt());
		System.out.println("enter required  quantity: ");
		shop.requestedQ(sc.nextBoolean(), sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt());
