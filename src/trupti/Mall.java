...
class Mall{
	...
	void displayCustomerInfo(){
         System.out.println(custName+" buys "+itemAdded+" items and payment done using "+paymentDone+ " in section "+section);
	}
	
	public static void main(String[] args){
		Mall mall=new Mall();
		mall.itemAddedToCart(0);
		if (mall.itemAdded<=0){
		  System.out.println("No any items added");
		}
		else {
