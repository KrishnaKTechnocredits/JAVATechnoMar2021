...
public class ReturnUniqueArray {
	...
	String getFebbonachiSeries(int range) {		
		String strOutPut = "";		
	...
	public static void main(String[] args) {
		ReturnUniqueArray returnUniqueArray1 = new ReturnUniqueArray();
		...
		System.out.println(returnUniqueArray1.getFebbonachiSeries(8));
