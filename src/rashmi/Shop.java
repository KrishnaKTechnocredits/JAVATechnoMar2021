...
public class Shop {
	...
	void purchase(int reqmaggie, int reqdosa, int reqpouch, int reqpanipuri, int reqmasala,boolean partial) {
		...
		if(reqmaggie>maggieq)
		{
			...
			{ 
			System.out.println("Requested maggie is " +reqmaggie+ " but available stock is "+maggieq+ "you can buy partial "+maggieq);
			maggieq =0;
			}
		}
	...
	{ 
			...
			if(true) {
	System.out.println("Requested dosa is " +reqdosa+ " but available stock is "+dosaq+ "you can buy partial "+dosaq);
	dosaq = 0;
}
	}
	...
	{ 
			...
			if(true)
	System.out.println("Requested pouch is " +reqpouch+ " but available stock is "+pouchesq+ "you can buy partial "+pouchesq);
	pouchesq = 0;
	...
	{ 
		if(true) {	
	System.out.println("Requested panipuri is " +reqpanipuri+ " but available stock is "+panipuriq+ "you can buy partial "+panipuriq);
	panipuriq = 0;
}
	}
	...
	System.out.println("Requested masala is " +reqmasala+ " but available stock is "+masalaq+ "you can buy partial "+masalaq);
	masalaq = 0;
}
	}
