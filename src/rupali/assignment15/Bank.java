...
public class Bank {
	...
	int totalIAmount=50000 , totalhAmount=40000 , totalBAmount=25000 , totalSAmount=30000;
	int totalAmount;
	...
	public static void main(String[] args) {
		Bank bank=new Bank();
		bank.transaction("Credit","ICICI" , 500);
		bank.transaction("Credit","ICICI" , 1000);
		bank.transaction("Debit","ICICI" , 10000);
		bank.transaction("Debit","ICICI" , 10000);

		bank.transaction("Credit","HDFC" , 500);
		bank.transaction("Debit","HDFC" , 1000);
		bank.transaction("Credit","HDFC" , 10000);
		bank.transaction("Debit","HDFC" , 10000);

		bank.transaction("Credit","BOB" , 1500);
		bank.transaction("Credit","BOB" , 600);
		bank.transaction("Credit","BOB" , 500);
