...
public class ArrayListOfTripletHavingMaxSum {
	...
	ArrayList<ArrayList<Integer>> getArrayListOfTriplet(int[] number) {
		...
		for (int index = 0; index < number.length - 2; index = index + 3) {
	...
	public static void main(String[] args) {
		ArrayListOfTripletHavingMaxSum triple = new ArrayListOfTripletHavingMaxSum();
