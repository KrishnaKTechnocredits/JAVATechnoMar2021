...
public class ReturnFirst5PrimeNum {
	...
	int[] getPrimeNum(int startRange, int endRange) {
	...
	public static void main(String[] args) {
		ReturnFirst5PrimeNum returnFirstFivePrimeNo = new ReturnFirst5PrimeNum();
		int startRange = 10;
		int endRange = 50;
		int[] arr1 = new int[endRange / 2];
		arr1 = returnFirstFivePrimeNo.getPrimeNum(startRange, endRange);
