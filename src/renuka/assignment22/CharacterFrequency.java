...
public class CharacterFrequency {
	...
	public static void main(String[] args) {
		...
		characterFrequency.frequency("technocredits", 'e');
		System.out.println("");
		characterFrequency.frequencyName("aakanksha");
		System.out.println("");
		String[] arr = {"raj", "aarya", "aavruti", "shruti"};
		characterFrequency.frequencyArray(arr);
