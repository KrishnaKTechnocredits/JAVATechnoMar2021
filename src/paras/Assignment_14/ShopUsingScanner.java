...
import paras.Assignment_7.Shop;
...
public class ShopUsingScanner {
	...
	public static void main(String[] args){
		...
		//shopusingscanner.setInitialQ(50,43,39,43,73);
		System.out.println("Please enter Initial Maggie Quantity");
		int maggieQ = scanner.nextInt();
		System.out.println("Please enter Initial Dosa Quantity");
		int dosaQ = scanner.nextInt();
		System.out.println("Please enter Initial Pouches Quantity");
		int pouchesQ = scanner.nextInt();
		System.out.println("Please enter Initial PaniPuri Quantity");
		int panipuriQ = scanner.nextInt();
		System.out.println("Please enter Initial Masala Quantity");
		int masalaQ = scanner.nextInt();
		shopusingscanner.setInitialQ(maggieQ, dosaQ, pouchesQ, panipuriQ, masalaQ);
		
		System.out.println("Please enter Requested Maggie Quantity");
		int maggieReqQ = scanner.nextInt();
		System.out.println("Please enter Requested Dosa Quantity");
		int dosaReqQ = scanner.nextInt();
		System.out.println("Please enter Requested Pouches Quantity");
		int pouchesReqQ = scanner.nextInt();
		System.out.println("Please enter Requested PaniPuri Quantity");
		int panipuriReqQ = scanner.nextInt();
		System.out.println("Please enter Requested Masala Quantity");
		int masalaReqQ = scanner.nextInt();
		shopusingscanner.requestedQuantity(maggieReqQ, dosaReqQ, pouchesReqQ, panipuriReqQ, masalaReqQ, true);
