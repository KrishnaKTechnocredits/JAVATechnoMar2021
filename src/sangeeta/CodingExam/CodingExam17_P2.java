/*triplet having maximum sum, index overlapping is allowed.
...
static int maxSum;
	...
	public static void main(String[] args) {
		CodingExam17_P2 codingExam17_P2 = new CodingExam17_P2();
		int [] arr = {1,10,2,3,1,11,4,2,1};
		ArrayList<ArrayList<Integer>> output = codingExam17_P2.tripletHavingMaxSum(arr);
