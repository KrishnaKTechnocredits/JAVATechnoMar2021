...
public class ShopThroughScanner {
	...
	public static void main(String[] args) {
		...
		ShopThroughScanner shopThroughScanner = new ShopThroughScanner();

		System.out.println("Enter Initial Quantity available for Maggy:-  ");
		int initialMaggyQty = scanner.nextInt();
		System.out.println("Enter Initial Quantity available for Dosa:-  ");
		int initialDosaQty = scanner.nextInt();
		System.out.println("Enter Initial Quantity available for Oil Pouches:-  ");
		int initialOilPouchesQty = scanner.nextInt();
		System.out.println("Enter Initial Quantity available for Panipuri Packets:-  ");
		int initialPanipuriPacksQty = scanner.nextInt();
		System.out.println("Enter Initial Quantity available for Masala Packets:-  ");
		int initialMasalaPacksQty = scanner.nextInt();

		shopThroughScanner.initialStocks(initialMaggyQty, initialDosaQty, initialOilPouchesQty, initialPanipuriPacksQty,
				initialMasalaPacksQty);
		shopThroughScanner.quantityAvailablInStock();

		System.out.println("Enter required Qty of Maggy asked by Customer:-  ");
		int requiredMaggyQty = scanner.nextInt();
		System.out.println("Enter required Qty of Dosa asked by Customer:-  ");
		int requiredDosaQty = scanner.nextInt();
		System.out.println("Enter required Qty of Oil Pouches asked by Customer:-  ");
		int requiredOilPouchesQty = scanner.nextInt();
		System.out.println("Enter required Qty of Panipuri Packets asked by Customer:-  ");
		int requiredPanipuriPacksQty = scanner.nextInt();
		System.out.println("Enter required Qty of Masala packets asked by Customer:-  ");
		int requiredMasalaPacksQty = scanner.nextInt();
		System.out.println("Partially Allowed or not:-  ");
		boolean partiallyAllowed = scanner.nextBoolean();

		shopThroughScanner.requestedQuantity(requiredMaggyQty, requiredDosaQty, requiredOilPouchesQty,
				requiredPanipuriPacksQty, requiredMasalaPacksQty, partiallyAllowed);
		shopThroughScanner.displayOutOfStockItems();
		shopThroughScanner.quantityAvailablInStock();
