...
public class Shop {
	...
	void requestedQuantity(int reqMaggiePack, int reqDosaPack, int reqOilPouch, int reqPanipuriPack, int reqMasalaPack,
		...
		if (totalMaggiePacks == 0)
			System.out.println("Requested Maggy Packets are out of stock");
		else if (reqMaggiePack <= totalMaggiePacks) {
		...
		if (totalDosaPacks == 0)
			System.out.println("Requested Dosa Packets are out of stock");
		else if (reqDosaPack <= totalDosaPacks) {
		...
		if (totalOilPouches == 0)
			System.out.println("Requested Oil Poches are out of stock");
		else if (reqOilPouch <= totalOilPouches) {
		...
		if (totalPanipuriPacks == 0)
			System.out.println("Requested Pani Puri Packets are out of stock");
		else if (reqPanipuriPack <= totalPanipuriPacks) {
		...
		if (totalMasalaPacks == 0)
			System.out.println("Requested Masala Packets are out of stock");
		else if (reqMasalaPack <= totalMasalaPacks) {
	...
	public static void main(String[] args) {
		...
		shop.requestedQuantity(5, 50, 50, 80, 100, true);
