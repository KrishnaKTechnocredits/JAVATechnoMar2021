...
class NumberGame {
	...
	void findMaxNumber(int num1, int num2, int num3) {
		System.out.println("User given Input " + num1 + "," + num2 + ", " + num3);

		if (num1 == num2 && num2 == num3) {// equal to comparison should be done first and then less than or greater
											// than comparison should be done(good Practice)
	...
	public static void main(String[] args) {
		...
		numberGame.findMaxNumber(5, 15, 12);
		numberGame.findMaxNumber(10, 10, 10);
		numberGame.findMinNumber(5, 3, 12);
