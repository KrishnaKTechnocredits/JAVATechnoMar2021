package ankit.assignment_29;

public class SumSequencePriningFromString {
	...
	public static void main(String[] args) {
		SumSequencePriningFromString sumSequencePriningFromString = new SumSequencePriningFromString();
