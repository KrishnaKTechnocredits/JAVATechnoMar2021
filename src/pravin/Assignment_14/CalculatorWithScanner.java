...
public class CalculatorWithScanner {
	...
	public static void main(String[] args) {
		...
		calculatorWithScanner.addition(number1,number2);
		calculatorWithScanner.subtraction(number1,number2);
		calculatorWithScanner.division(number1,number2);
		calculatorWithScanner.multiplication(number1,number2);
	}
